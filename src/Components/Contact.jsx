      ...
      <div className={`h-full pt-20 md:pt-6`}>
        <div className="mb-10">
          ...
          <h3 className="mx-4 md:mx-20 text-center">
            Here's the details you can use to get in touch with me or you can
            simply drop a message for me by filling the form below:
          </h3>
        </div>
        <div className="bg-skills">
          <div className="flex flex-col md:flex-row bg-[#ffffff10] backdrop-blur-lg text-white">
            ...
            <div className="flex w-full py-4 px-10 md:p-10 md:w-3/5">
              ...
              >
                ...
                <input
                  ...
                  className="w-full md:w-4/5 bg-[#33333320] p-2 border-2 border-white mt-4 my-1 rounded-lg"
                />
                <input
                  type="email"
                  name="Email Address"
