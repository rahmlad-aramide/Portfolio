export const DATA = [
  ...
  },
  {
    ...
    detail: "A Calculator App which was built for making simple mathematical calculations and similar to the Tip Calculator but this can be used for all types of basic mathematical calculation and also built with cool 3 themes from which user can select their choice of theme",
    languages: [
      {
        name: 'HTML',
        url: "images/Assets/html5-with-wordmark-color.svg",
